      ...
      <header className="sticky top-0 w-full bg-[#050505]/80 backdrop-blur-xl border-b border-white/5 z-50">
        <nav className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <Link href="#company" className="nav-link text-sm font-medium">
              Empresa
            </Link>
          </div>
            ...
            {userId ? (
              ...
              <>
                ...
                <SignUpButton mode="modal">
                  <button className="bg-white text-black px-5 py-2 rounded-full text-sm font-bold hover:bg-orange-500 hover:text-white transition-all duration-300 cursor-pointer">
                    Comienza gratis
                  </button>
                </SignUpButton>
              </>
        ...
        <section id="features" className="max-w-7xl mx-auto px-6 pb-32">
          ...
          <div className="mt-20 text-center">
            {userId ? (
              ...
              <SignUpButton mode="modal">
                <button className="btn-primary px-12 py-5 rounded-full font-bold text-lg cursor-pointer">
